...
public sealed class EmployeesController : Controller
{
    ...
    public async Task<IActionResult> Create(CreateEmployeeRequest request)
    {
        ...
        {
            // return same view if validation fails
            return View(request);
        }
    ...
    // GET: /admin/employees/Details?aadharNo=123
    [HttpGet("Details")]
    ...
    public async Task<IActionResult> DeleteConfirmed(string aadharNo)
    {
        ...
        // ✅ SUCCESS MESSAGE
        TempData["SuccessMessage"] = $"Employee with Aadhaar {aadharNo} deleted successfully.";
